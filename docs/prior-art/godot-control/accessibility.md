...
- **Avoid:** stuffing all a11y into the base Node class. Godot Control has `accessibility_*` properties on the base class; this is the same megacomponent shape Bevy fell into. Decomposed components per [`docs/prior-art/bevy-ui/lessons.md`](../bevy-ui/lessons.md) "Avoid" row 1.
