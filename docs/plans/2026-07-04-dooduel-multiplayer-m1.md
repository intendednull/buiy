...
- [x] **W3.5 RUN THE ARTIFACT.** `cargo run -p dooduel` — play a full solo match vs 3 bots to the podium; drawing, guessing, theming, avatar editor all live. Record findings in the commit body.
