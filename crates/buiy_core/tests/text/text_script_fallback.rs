...
/// Phase-1 `crate::support::headless_text_app`: this test registers a fixture font
/// through the production `FontRegistry::register_bytes` path
/// (`crate::support::register_fixture_font`), and the embedded `Fira Sans` it relies
...
fn resolved_face_families(arm: &Arm) -> (Vec<String>, bool, usize) {
    ...
    crate::support::register_fixture_font(&mut app, arm.noto_family, arm.fixture_file);
